...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"newDic.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteDic = exports.createDic = void 0;
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(dicName) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Dictionary Created successfully!');
              window.setTimeout(function () {
  ...
  return function createDic(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.createDic = createDic;
...
function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data === '') {
              (0, _alerts.showAlert)('success', 'Dictionary Deleted successfully!');
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
  ...
  return function deleteDic(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.deleteDic = deleteDic;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"../../node_modules/slugify/slugify.js":[function(require,module,exports) {
var define;
...
},{}],"newWord.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.editWord = exports.deleteWord = exports.createWord = void 0;
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(wordEng, wordTrans, slug) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/dics/".concat(slug, "/words"),
              data: {
                wordEng: wordEng,
                wordTrans: wordTrans,
                slug: slug
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Word Created successfully!');
              window.setTimeout(function () {
                location.assign("/dictionaries/".concat(slug));
              }, 1500);
            }
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(slug, dic_slug, user_name) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "/api/v1/words/".concat(slug, "&").concat(dic_slug, "&").concat(user_name)
            });
  ...
  return function deleteWord(_x4, _x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee3(wordEng, wordTrans, id, dicSLug) {
    var slug, res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            slug = (0, _slugify.default)(wordEng, {
              lower: true
            });
            _context3.prev = 1;
            _context3.next = 4;
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Word Edit successfully!');
              window.setTimeout(function () {
                location.assign("/dictionaries/".concat(dicSLug));
              }, 1500);
            }
  ...
  return function editWord(_x7, _x8, _x9, _x10) {
    return _ref3.apply(this, arguments);
  };
}();

exports.editWord = editWord;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","slugify":"../../node_modules/slugify/slugify.js"}],"signup.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"searchWord.js":[function(require,module,exports) {
"use strict";
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(word, lang, slug, user) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            window.location.href = "/dictionaries/".concat(slug, "/").concat(word, "&").concat(user, "&").concat(lang);
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","slugify":"../../node_modules/slugify/slugify.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _newDic = require("./newDic");

var _newWord = require("./newWord");
...
var newDic = document.querySelector('.form--newDic');
var newWord = document.querySelector('.newWord-form');
var signupForm = document.querySelector('.form--signup');
var logOutBtn = document.querySelector('.nav__el--logout');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var deleteDictionary = document.querySelectorAll('.dictionaries__delete');
var deleteWords = document.querySelectorAll('.word__delete');
var editWords = document.querySelector('.edit__word');
var searchWord = document.querySelector('.form--search');

if (searchWord) {
  searchWord.addEventListener('submit', function (e) {
    e.preventDefault();
    var dictionarySlug = document.getElementById('dictionary').innerHTML;
    var dictionaryUser = document.getElementById('user').innerHTML;
    var searchParamater = document.getElementById('search').value;
    var lang = null;
    ...
    if (lang === null) {
      (0, _alerts.showAlert)('error', 'No Lang Specified');
    }

    (0, _searchWord.search)(searchParamater, lang, dictionarySlug, dictionaryUser);
  });
}

if (editWords) {
  editWords.addEventListener('submit', function (e) {
    e.preventDefault();
    var wordEng = document.getElementById('wordEng').value;
    var wordTrans = document.getElementById('wordTrans').value;
    var id = document.getElementById('id').value;
    var dicSLug = document.getElementById('dic_slug').value;
    (0, _newWord.editWord)(wordEng, wordTrans, id, dicSLug);
  });
}

if (deleteWords) {
  deleteWords.forEach(function (i, k) {
    i.addEventListener('click', function (e) {
      e.preventDefault();
      var dictionaryName = i.parentElement.parentElement.parentElement.querySelector('.dictionary__name').innerHTML;
      var user = i.parentElement.parentElement.parentElement.querySelector('.user__name').innerHTML;
      var wordEng = (0, _slugify.default)(i.parentElement.parentElement.querySelector('.word_name').innerHTML, {
        lower: true
      });
      var dictionary = (0, _slugify.default)(dictionaryName, {
        lower: true
      });
      (0, _newWord.deleteWord)(wordEng, dictionary, user);
    });
  });
}

if (deleteDictionary) {
  deleteDictionary.forEach(function (i, k) {
    i.addEventListener('click', function (e) {
      e.preventDefault();
      var dicName = (0, _slugify.default)(i.parentElement.parentElement.querySelector('.dic__name').innerHTML, {
        lower: true
      });
      (0, _newDic.deleteDic)(dicName);
    });
  });
} // DELEGATION
...
if (newDic) {
  newDic.addEventListener('submit', function (e) {
    e.preventDefault();
    var dicName = document.getElementById('dicName').value;
    (0, _newDic.createDic)(dicName);
  });
}

if (newWord) {
  newWord.addEventListener('submit', function (e) {
    e.preventDefault();
    var wordEng = document.getElementById('wordEng').value;
    var wordTrans = document.getElementById('wordTrans').value;
    var slug = document.getElementById('slug').value;
    (0, _newWord.createWord)(wordEng, wordTrans, slug);
  });
}
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "2985" + '/');
